...
There are also some instances where preserving a quote's original formatting can help to improve the readability of the quote. They're rarely useful as there is limited screen space to work with, but I have gone ahead and added them anyway.
...
Add this character to put a blank line between the text preceeding the character and succeeding the character (equivalent to `\r\n` x2).
