...
time_font = 'bookerlybold.ttf'                  # bold version of quote_font *fntname_high
info_font = 'bookerlybold.ttf'                  # the font the book and Author's name will be written in *fntname_mdata
